# 07 — Expose coverage and warnings throughout delivery

**What to build:** Show users the conversion's coverage, confidence, and warnings in clear Vietnamese from the report API through the completed-job interface, without withholding a structurally valid download.
