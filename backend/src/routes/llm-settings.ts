/**
 * Per-user LLM settings routes
 * GET    /api/settings/llm          — get current user's LLM config
 * POST   /api/settings/llm          — create/update LLM config
 * POST   /api/settings/llm/test     — test connection to LLM provider
 * DELETE /api/settings/llm          — delete LLM config
 */
