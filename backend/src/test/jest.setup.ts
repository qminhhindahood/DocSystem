...
// BYOK vision key storage — encryption.ts reads this at module load.
process.env.LLM_CONFIG_ENCRYPTION_KEY = process.env.LLM_CONFIG_ENCRYPTION_KEY || 'ab'.repeat(32);
